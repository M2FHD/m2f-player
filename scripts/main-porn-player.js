/**
 * Embed Porn Player Script
 * สคริปต์สำหรับฝังเครื่องเล่นสื่อ Porn
 * 
 * วิธีการใช้งาน:
 * <script src="https://cdn.jsdelivr.net/gh/M2FHD/m2f-player@main/scripts/main-porn-player.js"
 *     data-id="porn-dvd_id"
 *     data-type="porn"
 *     data-width="100%"
...
(function() {
    ...
    if (!currentScript) {
        console.error('Embed Porn Player: Cannot find script tag');
        return;
    }
    ...
    var type = currentScript.getAttribute('data-type') || 'porn';
    ...
    if (!params.id) {
        console.error('Embed Porn Player: data-id is required');
        return;
    }
    ...
    console.log('Embed Porn Player: Loaded successfully', {
        id: params.id,
        type: params.type,
        skin: params.skin,
        theme: params.theme,
